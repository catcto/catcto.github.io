...
var _Model = require('./core/Model.es6');

var _Model2 = _interopRequireDefault(_Model);

var _View = require('./core/View.es6');

var _View2 = _interopRequireDefault(_View);

var _Control = require('./core/Control.es6');
...
},{"./core/Control.es6":327,"./core/Model.es6":328,"./core/View.es6":329,"babel-polyfill":1}],327:[function(require,module,exports){
'use strict';
...
var _Event = require('../lib/Event.es6');

var _Event2 = _interopRequireDefault(_Event);

var _timer = require('../lib/timer.es6');
...
var Constrol = function () {
	function Constrol(model, view) {
		...
		model.tiles.forEach(function (cell) {
			Reflect.defineProperty(cell, "index", {
				...
				get: function get() {
					return Reflect.get(cell, "_index");
				}
			});
			...
			Reflect.defineProperty(cell, "removed", {
				...
				get: function get() {
					return Reflect.get(cell, "_removed") || false;
				}
			});
		});
...
},{"../lib/Event.es6":330,"../lib/timer.es6":333}],328:[function(require,module,exports){
'use strict';
...
var _shuffle = require('../lib/shuffle.es6');
...
},{"../lib/pixi.extension":331}],330:[function(require,module,exports){
"use strict";
